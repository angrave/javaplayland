window.appendBar = (d) ->
	...
	$(ref).attr({"height":"40%","width":"30%","alt":"Java book","src":"img/cc0/Spiral_bound_book-128px.png","title":"Java book"})
	$(ref).css({"position":"absolute","top":"6.6%","right":"5%"})
	$(select).attr({"height":"40%","width":"35%","alt":"Select level","src":"img/cc0/treasuremap-128px.png","title":"Select level"})
